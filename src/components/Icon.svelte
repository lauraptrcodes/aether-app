...
<section>
    {#if iconName === "globe"}
        <svg
            ...
            class="lucide lucide-globe-2 {tailwindClasses}"
    ...
    {:else if iconName === "add"}
        <svg
            xmlns="http://www.w3.org/2000/svg"
            class="icon icon-tabler icon-tabler-plus {tailwindClasses}"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            stroke-width="2"
    ...
    {:else if iconName === "heart"}
        <svg
            xmlns="http://www.w3.org/2000/svg"
            class="icon icon-tabler icon-tabler-heart {tailwindClasses}"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            stroke-width="2"
    ...
    {:else if iconName === "mute"}
        <svg
            xmlns="http://www.w3.org/2000/svg"
            class="icon icon-tabler icon-tabler-volume-3 {tailwindClasses}"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            stroke-width="1.5"
